const data = [
...

   {
    ...
    },
    {
      ...
      name: "Men's Jacket",
      price: 80,
      promoPrice: 75.10, // 10% discount
      discountPercentage: 10,
      description: "Elevate your casual wardrobe with this stylish men’s denim jacket. Crafted from high-quality denim, it offers a sleek modern fit that complements any outfit. Lightweight yet durable, it’s perfect for layering in cooler weather while maintaining comfort and versatility. Whether for a laid-back day out, casual Fridays, or weekend getaways, this jacket adds a timeless edge to your style.",
      category: "Clothing",
      availableQuantity: 10,
      images: {
